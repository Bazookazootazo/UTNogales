...
// ==========================================
try {
    // Usamos GROUP_CONCAT para traer los logos de los patrocinadores en una sola celda separados por coma
...
function abrirModalEditarCarrera(carrera) {
    // 1. Llenar todos los campos de texto/número
    ...
    // MySQL devuelve la fecha como "YYYY-MM-DD HH:MM:SS". El input type="date" solo acepta "YYYY-MM-DD"
    ...
    // 2. Manejar Patrocinadores: Desmarcar todos primero
    const checkboxes = document.querySelectorAll('.edit-sponsor-checkbox');
    checkboxes.forEach(chk => chk.checked = false);

    // 3. Marcar los que vienen en la base de datos
